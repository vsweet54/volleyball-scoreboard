...
local BrowseExecCopyPath = Instance.new("TextButton"); -- NEW
...
BrowseExecFrame.Size = UDim2.new(0, 230, 0, 200); -- digedein dari 170
...
-- NEW: Copy Remote Path button
BrowseExecCopyPath.Name = "BrowseExecCopyPath";
BrowseExecCopyPath.Parent = BrowseExecFrame;
BrowseExecCopyPath.BackgroundColor3 = colorSettings.MainButtons.BackgroundColor;
BrowseExecCopyPath.BorderColor3 = colorSettings.MainButtons.BorderColor;
BrowseExecCopyPath.Position = UDim2.new(0, 8, 0, 162);
BrowseExecCopyPath.Size = UDim2.new(0, 214, 0, 26);
BrowseExecCopyPath.ZIndex = 21;
BrowseExecCopyPath.Font = Enum.Font.SourceSans;
BrowseExecCopyPath.Text = "Copy Remote Path";
BrowseExecCopyPath.TextColor3 = Color3.fromRGB(250, 251, 255);
BrowseExecCopyPath.TextSize = 16;
...
-- NEW: Copy Remote Path handler
BrowseExecCopyPath.MouseButton1Click:Connect(function()
	local r = browseSelRemote
	if not r then return end
	setclipboard(GetFullPathOfAnInstance(r))
	ButtonEffect(BrowseExecCopyPath, "Copied!")
end)
